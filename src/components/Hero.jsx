...
export default function Hero() {
  return (
    <section className="flex h-dvh justify-center items-center">
      <div className="flex flex-col w-1/2 max-sm:w-full max-sm:px-6 mt-6 max-md:text-center ">
        ...
        <div className="button flex gap-4 mt-11 flex-row max-md:items-center max-md:flex-col">
          <LargeBtn title={"Download CV"} />
          <LargeBtn title={"Let's Work"} BtnStyle={true} />
        </div>
      </div>
    </section>
  );
